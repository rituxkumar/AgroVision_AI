...
export default function ScanPage() {
    ...
    const handleAnalyze = async () => {
        ...
        // Fake delay (replace later with ML API call)
        setTimeout(() => {
            setResult({
                disease: "Leaf Rust",
                confidence: "92%",
                medicine: "Apply Mancozeb Fungicide twice weekly.",
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                        ...
                        <div className="bg-green-50 dark:bg-green-900 p-6 rounded-xl">
                            ...
                            <button className="mt-6 px-6 py-2 bg-green-600 text-white rounded-lg hover:scale-105 transition">
                                Buy Medicine Online
                            </button>
                        </div>
                        <button
                            onClick={handleDownloadPDF}
                            className="mt-6 px-6 py-2 bg-green-700 text-white rounded-lg hover:scale-105 transition"
                        >
                            Download PDF
                        </button>
